const TermsPrivacy = () => {
  return (
    <div className="terms-page" aria-labelledby="terms-privacy-page">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to AFC News.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to AFC News, accessible from
            <a
              href="www.afcnews.com.au"
      ...
      <ul>
        <li>By email: admin@afcnews.com.au</li>
      </ul>
